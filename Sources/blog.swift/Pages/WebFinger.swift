...
struct WebFinger: Page {
    ...
    func content() -> Node {
        let webfinger = JSON.object([
            "subject": .string("acct:dvk@chaos.social"),
            "aliases": .array([
                .string("https://chaos.social/@dvk"),
                .string("https://chaos.social/users/dvk")
            ]),
            "links": .array([
                .object([
                    "rel":  .string("http://webfinger.net/rel/profile-page"),
                    "type": .string("text/html"),
                    "href": .string("https://chaos.social/@dvk"),
                ]),
                .object([
                    "rel":  .string("self"),
                    "type": .string("application/activity+json"),
                    "href": .string("https://chaos.social/users/dvk"),
                ]),
                .object([
                    "rel":  .string("http://ostatus.org/schema/1.0/subscribe"),
                    "href": .string("https://chaos.social/authorize_interaction?uri={uri}"),
                ]),
            ])
        ])
